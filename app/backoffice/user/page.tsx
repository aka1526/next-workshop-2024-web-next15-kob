...
export default function UserPage() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get( '/api/proxy/user/list');
    ...
    const handleSave = async () => {
        try {
            ...
            if (id == 0) {
                const response = await axios.post('/api/proxy/user/create', payload);
            } else {
                const response = await axios.post('/api/proxy/user/update', payload);
                setId(0);
            }
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            await axios.post( '/api/proxy/user/remove' ,payload);
            fetchData();
        } catch (e: any) {
            Swal.fire({
                title: 'error',
