...
export default function Page() {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get('/api/proxy/foodsize/list');
    ...
    const remove = async (item: any) => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post('/api/proxy/foodsize/remove/',payload);
                fetchData();
            }
        } catch (e: any) {
            Swal.fire({
    ...
    const save = async () => {
        try {
            ...
            if (id == 0) {
                await axios.post('/api/proxy/foodsize/create', payload);
            } else {
                await axios.put( '/api/proxy/foodsize/update', payload);
                setId(0);
            }
