        ...
        try {
            ...
            if (id == 0) {
              //  await axios.post(config.apiServer + '/api/foodType/create', payload);
                const res = await axios.post('/api/proxy/foodtype/create', payload);
            } else {
               // await axios.put(config.apiServer + '/api/foodType/update', payload);
                const res = await axios.post('/api/proxy/foodtype/update', payload);
                setId(0);
            }
              fetchData();
    ...
    const handleRemove = async (item: any) => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post(config.apiServer + '/api/foodType/remove/',payload);
                fetchData();
            }
        } catch (e: any) {
            Swal.fire({
