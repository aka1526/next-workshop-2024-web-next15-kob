...
export default function Page() {
  ...
  const handleCloseModal = () => setShowModal(false);
    ...
    const getFoods = async () => {
        try {
            const res = await axios.get('/api/proxy/food/list');
    ...
    const filterFoods = async (foodType: string) => {
        try {
            ...
            const res = await axios.post('/api/proxy/food/filter',payload);
            setFoods(res.data.results);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const sale = async (foodId: number) => {
        try {
            ...
            await axios.post('/api/proxy/saletemp/create', payload);
            fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const fetchDataSaleTemp = async () => {
        try {
            ...
            const res = await axios.get('/api/proxy/saletemp/list');
    ...
    const removeSaleTemp = async (id: number) => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post('/api/proxy/saletemp/remove/',payload);
                fetchDataSaleTemp();
            }
        } catch (e: any) {
            Swal.fire({
    ...
    const removeAllSaleTemp = async () => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post('/api/proxy/saletemp/removeAll', payload);
                fetchDataSaleTemp();
            }
        } catch (e: any) {
            Swal.fire({
    ...
    const updateQty = async (id: number, qty: number) => {
        try {
            ...
            await axios.put('/api/proxy/saletemp/updateQty', payload);
            fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const genereateSaleTempDetail = async (saleTempId: number) => {
        try {
            ...
            await axios.post('/api/proxy/saletemp/generateSaleTempDetail', payload);
    ...
    const fetchDataSaleTempInfo = async (saleTempId: number) => {
        try {
            ...
            const res = await axios.post('/api/proxy/saletemp/info',payload);
    ...
    const selectTaste = async (tasteId: number, saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await axios.post(config.apiServer + '/api/proxy/saletemp/selecttaste', payload);
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const unSelectTaste = async (saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await axios.post( '/api/proxy/saletemp/unSelectTaste', payload);
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const selectSize = async (sizeId: number, saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await axios.put('/api/proxy/saletemp/selectSize', payload);
    ...
    const unSelectSize = async (saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await axios.post('/api/proxy/saletemp/unSelectSize', payload);
            await fetchDataSaleTempInfo(saleTempId);
            await fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
    ...
    const createSaleTempDetail = async () => {
        try {
            ...
            await axios.post('/api/proxy/saletemp/createSaleTempDetail', payload);
            await fetchDataSaleTemp();
            await fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
    ...
    const removeSaleTempDetail = async (saleTempDetailId: number) => {
        try {
            ...
            await axios.post('/api/proxy/saletemp/removeSaleTempDetail', { data: payload });
            await fetchDataSaleTemp();
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
    ...
    const printBillBeforePay = async () => {
        try {
            ...
            const res = await axios.post('/api/proxy/saletemp/printBillBeforePay', payload);
            setTimeout(() => {
    ...
    const endSale = async () => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post('/api/proxy/saletemp/endSale', payload);
                fetchDataSaleTemp();
    ...
    const printBillAfterPay = async () => {
        try {
            ...
            const res = await axios.post('/api/proxy/saletemp/printBillAfterPay', payload);
                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <button type="button" className="btn btn-primary me-1" onClick={handleShowModal}>
                            ค้นหาสินค้า   
                    ...
                    <h6 > ชื่อสินค้า: {selectedProduct?.id}{selectedProduct?.name}</h6>
                    </div>
                                ...
                                {foods.map((food: any) =>
                                    <div className="col-md-3 col-lg-3 col-sm-4 col-6" key={food.id}>
                                        ...
                                        cursor: "pointer"
                                            ...
                                            <img className="img-fluid" src={config.apiServer + '/uploads/' + food.img}
