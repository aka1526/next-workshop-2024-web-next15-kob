...
export default function Page() {
    ...
    const fetchData = async () => {
        try {
            ...
            const res = await axios.get( '/api/proxy/taste/list');
    ...
    const handleSave = async () => {
        try {
            ...
            if (id === 0) {
                await axios.post('/api/proxy/taste/create', payload);
            } else {
                await axios.post('/api/proxy/taste/update', payload);
                setId(0);
            }
    ...
    const handleRemove = async (item: any) => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post('/api/proxy/taste/remove',payload);
                fetchData();
            }
        } catch (e: any) {
            Swal.fire({
