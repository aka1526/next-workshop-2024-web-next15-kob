    ...
    const fetchDataFoodTypes = async () => {
        try {
           // const res = await axios.get(config.apiServer + '/api/foodtype/list');
            const res = await axios.get('/api/proxy/foodtype/list');
        ...
        try {
            ...
            if (id == 0) {
               // await axios.post(config.apiServer + '/api/food/create', payload);
                await axios.post( '/api/proxy/food/create', payload);
            } else {
               // await axios.put(config.apiServer + '/api/food/update', payload);
                await axios.put(  '/api/proxy/food/update', payload);
                setId(0);
            }
    ...
    const handleUpload = async () => {
        try {
           ...
           // const res = await axios.post(config.apiServer + '/api/food/upload', formData);
            const res = await axios.post('/api/proxy/food/upload', formData,{
                headers: {
    ...
    const handleRemove = async (id: number) => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await axios.post( '/api/proxy/food/remove/',payload);
                fetchData();
            }
        } catch (e: any) {
            Swal.fire({
